...
const pagesRoutes: Routes = [
    {
        ...
        children: [
            ...
            { path: 'generar-reclamo-ciudadano', component: GenerarReclamoCiudadanoComponent, data: { titulo: 'Reclamo', subtitulo: 'Registrar Reclamo' }},
            ...
            { path: 'registrar-reclamo', component: RegistrarReclamoComponent, data: { titulo: 'Reclamo', subtitulo: 'Enviar Reclamo' }},
            ...
            { path: 'reclamo', component: ReclamoComponent, data: { titulo: 'Dominio', subtitulo: 'Reclamo'}},
